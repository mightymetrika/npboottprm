...
#'
#' @examples
#' replext_t6_c1.1(n = c(5, 10), n_simulations = 5)
#'
#' @references
...
#'
#' @examples
#' replext_t6_c1.2(n = c(5, 10), n_simulations = 5)
#'
#' @references
#' Dwivedi AK, Mallawaarachchi I, Alvarado LA. Analysis of small sample size
#' studies using nonparametric bootstrap test with pooled resampling method.
...
#'
#' @examples
#' replext_t6_c1.3(n = c(5, 10), n_simulations = 5)
#'
#' @references
#' Dwivedi AK, Mallawaarachchi I, Alvarado LA. Analysis of small sample size
#' studies using nonparametric bootstrap test with pooled resampling method.
...
#'
#' @examples
#' replext_t6_c2.1(n = c(5, 10), n_simulations = 5)
#'
#' @references
#' Dwivedi AK, Mallawaarachchi I, Alvarado LA. Analysis of small sample size
#' studies using nonparametric bootstrap test with pooled resampling method.
...
#'
#' @examples
#' replext_t6_c2.2(n = c(5, 10), n_simulations = 5)
#'
#' @references
#' Dwivedi AK, Mallawaarachchi I, Alvarado LA. Analysis of small sample size
#' studies using nonparametric bootstrap test with pooled resampling method.
...
#'
#' @examples
#' replext_t6_c2.3(n = c(5, 10), n_simulations = 5)
#'
#' @references
#' Dwivedi AK, Mallawaarachchi I, Alvarado LA. Analysis of small sample size
#' studies using nonparametric bootstrap test with pooled resampling method.
